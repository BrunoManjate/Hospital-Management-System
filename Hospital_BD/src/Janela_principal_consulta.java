...
public class Janela_principal_consulta extends JFrame 
{
	private JButton adicionar, editar,apagar, visualizar, voltar, sair;
	private Container cont;
	private JPanel p1;
	public Janela_principal_consulta() 
	{
		super("Tabela De Consultas");
		...
		visualizar.addActionListener(new ActionListener() 
		{
			...
			{
				dispose();
				new Janela_visualizar_consulta();
			}
		});
		p1.add(visualizar); 
